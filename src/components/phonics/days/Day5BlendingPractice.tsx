...
const Day5BlendingPractice: React.FC<DayComponentProps> = ({ phoneme, onComplete }) => {
  return (
    <motion.div
    ...
    >
      ...
      <h3 className="text-2xl font-bold text-gray-700">Mix the Sounds</h3>
      <p className="text-gray-600">Blending practice for {phoneme.phoneme}</p>
...
export default Day5BlendingPractice;